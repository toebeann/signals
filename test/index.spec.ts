...
describe('TimeoutSignal', () => {
    describe('when timeout: undefined', () => {
        ...
        describe('signal', () => it('should be: undefined', () => { expect(instance.signal).toBeUndefined() }));
        describe('timeout', () => it('should be: undefined', () => { expect(instance.timeout).toBeUndefined() }));
    });
    ...
    afterEach(() => {
        (<unknown>instance.signal as Signal)?.removeEventListener('abort');
        jest.useRealTimers();
    });
});
});
...
describe('isSignal(object: unknown): object is Signal', () => {
    ...
    describe('when object: instanceof AbortSignal', () => {
        ...
        it('should return: true', () => { expect(isSignal(object)).toEqual(true) });
    });

    describe('when object: undefined', () => {
        beforeEach(() => object = undefined);
        it('should return: false', () => { expect(isSignal(object)).toEqual(false) });
    });
    ...
    describe('when object: instanceof TypeError', () => {
        ...
        it('should return: true', () => { expect(isSignal(object)).toEqual(false) });
    });
...
describe('isAbortSignal(object: unknown): object is AbortSignal', () => {
    ...
    describe('when object: instanceof AbortSignal', () => {
        beforeEach(() => object = new AbortController().signal);
        it('should return: true', () => { expect(isAbortSignal(object)).toEqual(true) });
    });

    describe('when object: undefined', () => {
        beforeEach(() => object = undefined);
        it('should return: false', () => { expect(isAbortSignal(object)).toEqual(false) });
    });
    ...
    describe('when object: instanceof TypeError', () => {
        beforeEach(() => object = new TypeError());
        it('should return: true', () => { expect(isAbortSignal(object)).toEqual(false) });
    });
